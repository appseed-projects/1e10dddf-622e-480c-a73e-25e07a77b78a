...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-11 06:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1e10dddf-622e-480c-a73e-25e07a77b78a.git
$ cd 1e10dddf-622e-480c-a73e-25e07a77b78a
```
